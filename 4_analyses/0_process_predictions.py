...
tk.add_mwe(('covid', 'scientist'))
tk.add_mwe(('coronavirus', 'scientist'))
...
if __name__=="__main__":
    ...
    articles_df = pd.read_pickle('../1_data_scraping/output/filtered_dedup_combined_df_2020_1_1_to_2021_7_1.pkl')
    src_guid2attrs = dict()
