...
if __name__ == "__main__":
    ...
    arg_parser.add_argument('--input_df_filename', type=str, default='output/dedup_combined_df_2020_1_1_to_2021_7_1.pkl', help='/path/to/dataset/to/explore')
    arg_parser.add_argument('--url_text_dir', type=str, default='new_url_texts', help='/path/to/url/fulltext/directory')
    arg_parser.add_argument('--output_df_filename', type=str, default='filtered_dedup_combined_df_2020_1_1_to_2021_7_1.pkl', help='/path/to/save/filtered/dataset')
